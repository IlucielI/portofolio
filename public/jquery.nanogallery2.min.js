     ...
     */ (e.nanogallery2 = function (e, t) {
                     ...
                     (window.NGY2Item = (function () {
                         ...
                         (t.Get = function (e, t) {
                             ...
                             (t.New = function (e, n, i, o, r, l, s) {
                                 ...
                                 if (
                                     "string" ==
                                     typeof e.galleryFilterTags.Get()
                                 )
                                     switch (
         ...
         (jQuery.nanogallery2.defaultOptions = {
             ...
             viewerTools: {
                 ...
                 topRight:
                     "rotateLeft,rotateRight,fullscreenButton,closeButton",
             },
             ...
             icons: {
                 ...
                 buttonClose:
                     '<lord-icon src="https://cdn.lordicon.com/gmzxduhd.json" trigger="loop" colors="primary:#9cf4df,secondary:#08a88a" style="width:50px;height:50px"></lord-icon>',
                 ...
                 viewerPlay:
                     '<lord-icon src="https://cdn.lordicon.com/tdxypxgp.json" trigger="loop" colors="primary:#9cf4df,secondary:#08a88a" style="width:60px;height:60px"></lord-icon>',
                 viewerPause:
                     '<lord-icon src="https://cdn.lordicon.com/rzrkjbrm.json" trigger="loop" colors="primary:#9cf4df,secondary:#08a88a" style="width:60px;height:60px"></lord-icon>',
                 viewerFullscreenOn:
                     '<lord-icon src="https://cdn.lordicon.com/fgkmrslx.json" trigger="loop" colors="primary:#9cf4df,secondary:#08a88a" style="width:50px;height:50px"></lord-icon>',
                 viewerFullscreenOff:
                     '<lord-icon src="https://cdn.lordicon.com/tyounuzx.json" trigger="loop" colors="primary:#9cf4df,secondary:#08a88a" style="width:50px;height:50px"></lord-icon>',
                 ...
                 viewerRotateLeft:
                     '<lord-icon src="https://cdn.lordicon.com/iiueiwdd.json" trigger="loop-on-hover" colors="primary:#16c79e,secondary:#08a88a" style="width:25px;height:25px"></lord-icon>',
                 viewerRotateRight:
                     '<lord-icon src="https://cdn.lordicon.com/gkditgni.json" trigger="loop-on-hover" colors="primary:#16c79e,secondary:#08a88a" style="width:25px;height:25px"></lord-icon>',
                 ...
                 return (
                     ...
                     (t.emitEvent = function (e, t) {
                         ...
                         if (n && n.length) {
                             ...
                             for (
                                 var o =
                                     this._onceEvents && this._onceEvents[e];
                                 a;
         ...
         (function (e, t, n, i) {
             ...
             function J(e, t) {
                 ...
                 return (
                     12 & t && (n = S(n.concat(i), "identifier", !0)), [n, i]
                 );
             }
             f(Z, Y, {
                 handler: function (e) {
                 ...
                 f(ye, ce, {
                     ...
                     process: function (e) {
                         var t = this.options,
                             ...
                             a = e.deltaTime < t.time;
                         if (
                             (this.reset(), 1 & e.eventType && 0 === this.count)
                         )
