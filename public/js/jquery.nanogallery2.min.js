        ...
        (jQuery.nanogallery2.defaultOptions = {
            ...
            icons: {
                ...
                navigationPaginationPrevious:
                    '<img src="img/left-chevron.png" alt="LEFT" width=20 height=20>',
                navigationPaginationNext:
                    '<img src="img/right-chevron.png" alt="RIGHT" width=20 height=20>',
                thumbnailSelected:
                ...
                buttonClose:
                    '<lord-icon src="json/home.json" trigger="loop-on-hover" colors="primary:#9cf4df,secondary:#08a88a" style="width:50px;height:50px"></lord-icon>',
                viewerPrevious: '<i class="nGY2Icon-ngy2_chevron-left"></i>',
                viewerNext: '<i class="nGY2Icon-ngy2_chevron-right"></i>',
                viewerImgPrevious:
                    '<img src="img/left-chevron.png" alt="LEFT" width=40 height=40>',
                viewerImgNext:
                    '<img src="img/right-chevron.png" alt="RIGHT" width=40 height=40>',
                ...
                viewerPlay:
                    '<lord-icon src="json/film.json" trigger="loop-on-hover" colors="primary:#9cf4df,secondary:#08a88a" style="width:60px;height:60px"></lord-icon>',
                viewerPause:
                    '<lord-icon src="json/clipboard.json" trigger="loop-on-hover" colors="primary:#9cf4df,secondary:#08a88a" style="width:60px;height:60px"></lord-icon>',
                viewerFullscreenOn:
                    '<lord-icon src="json/photo.json" trigger="loop-on-hover" colors="primary:#9cf4df,secondary:#08a88a" style="width:50px;height:50px"></lord-icon>',
                viewerFullscreenOff:
                    '<lord-icon src="json/eyes.json" trigger="loop-on-hover" colors="primary:#9cf4df,secondary:#08a88a" style="width:50px;height:50px"></lord-icon>',
                ...
                viewerRotateLeft:
                    '<lord-icon src="json/leftarrow.json" trigger="loop-on-hover" colors="primary:#9cf4df,secondary:#08a88a" style="width:30px;height:30px"></lord-icon>',
                viewerRotateRight:
                    '<lord-icon src="json/rightarrow.json" trigger="loop-on-hover" colors="primary:#9cf4df,secondary:#08a88a" style="width:30px;height:30px"></lord-icon>',
